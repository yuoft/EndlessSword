...
import static com.yuo.es.Items.ESSlashItem.addInfo;
import static com.yuo.es.Items.ESSlashItem.hit;

public class ESSlashItem0 extends ItemSlashBlade {
    public ESSlashItem0() {
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot, ItemStack stack) {
        ...
        if (slot == EquipmentSlotType.MAINHAND) {
            ...
            state.ifPresent((s) -> {
                ...
                s.setModel(new ResourceLocation(EndlessSword.MOD_ID, "model/aa.obj"));
                s.setTexture(new ResourceLocation(EndlessSword.MOD_ID, "model/aa.png"));
                s.setKillCount(0);
                s.setRefine(0);
    ...
    public void fillItemGroup(ItemGroup group, NonNullList<ItemStack> items) {
        if (group == EndlessTab.endless) {
            ...
            stack.getCapability(ItemSlashBlade.BLADESTATE).ifPresent(e ->{
                e.setModel(new ResourceLocation(EndlessSword.MOD_ID, "model/aa.obj"));
                e.setTexture(new ResourceLocation(EndlessSword.MOD_ID, "model/aa.png"));
            });
            items.add(stack);
        }
    }
